                ...
                if str(message.author.id) in chats["chats"]:
                    ...
                    if str(dest) in chats["chats"]:
                        ...
                        if len(message.attachments) > 0:
                            return await ctx.send(embed=discord.Embed(title="No se pueden los adjuntos", description="Las imagenes, tts, etc no estan permitidos en el chat de {self.bot.mention}"))
