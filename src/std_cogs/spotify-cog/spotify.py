...
class Spotify(commands.Cog):
    ...
    def custom_panel(self, title="Title text", subtitle="Subtitle text", description="Description text here", icon="https://cdn.discordapp.com/embed/avatars/0.png", spt=None):
        ...
        if SPOTIFY:
            ...
            DRAW.text((MARGIN_LEFT, MARGIN_TOP + 70), STR_CURRENT, font=SUBTITLE_FONT, fill="#2ecc71")
            DRAW.text((MARGIN_RIGHT - DURATION_LEFT_SIZE, MARGIN_TOP + 70), STR_END, font=SUBTITLE_FONT, fill="#2ecc71")
